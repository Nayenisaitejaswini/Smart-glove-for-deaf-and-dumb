...
const char* messages[] = {
  ...
  "I am scared", "water","Hungry", "I am happy now", "Help",
  "Fine", "Need medicine", "Restroom", "Good morning"
};
...
void loop() 
{
  ...
  } else if (ind>15 && mid > 15 && rng > 15 && sm > 15) {
    newMessageIndex = 7; // "water"
  } else if (thm>15 && ind > 15 && mid > 15 && rng > 15 && sm > 15) {
    newMessageIndex = 8; // "hungry"
  } else if (thm > 15 && ind > 15 && sm > 15) {
    newMessageIndex = 9; // "I am happy now"
  }else if (mid > 15 && rng > 15 && thm>15) {
    newMessageIndex = 10; // "help"
  } else if (ind > 30) {
    newMessageIndex = 11; // "Fine"
  } else if (mid > 30) {
    newMessageIndex = 12; // Need medicine 
  } else if (sm > 30) {
    newMessageIndex = 13; // Restroom
  } //else if (sm > 50) {
  // newMessageIndex = 14;
  // }
